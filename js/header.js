      ...
      <header class="main-header">
        <nav class="navbar navbar-expand-lg navbar-dark">
          <div class="container">
            <!-- Logo -->
            <div class="logo">
              <a href="Film-Sitesi/index.html">DİZİ<span>COM</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a class="nav-link active" href="Film-Sitesi/index.html"><i class="fas fa-home me-1"></i> Anasayfa</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="Film-Sitesi/diziler.html"><i class="fas fa-tv me-1"></i> Diziler</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="Film-Sitesi/filmler.html"><i class="fas fa-film me-1"></i> Filmler</a>
                </li>
                <li class="nav-item">
